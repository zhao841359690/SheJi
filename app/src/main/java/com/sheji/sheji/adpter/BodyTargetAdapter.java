...
public class BodyTargetAdapter extends RecyclerView.Adapter<BodyTargetAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public BodyTargetAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
