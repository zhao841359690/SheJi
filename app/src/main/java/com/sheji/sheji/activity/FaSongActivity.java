...
public class FaSongActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fa_song);
        ...
        button_open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (serialPort == null) {
                    Log.e(TAG, "串口打开失败");
                    Toast.makeText(FaSongActivity.this, "串口打开失败", Toast.LENGTH_SHORT).show();
                    return;
                }
                textView_status.setText("串口已打开");
                Toast.makeText(FaSongActivity.this, "串口已打开", Toast.LENGTH_SHORT).show();
        ...
        button_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(FaSongActivity.this, "串口关闭成功", Toast.LENGTH_SHORT).show();
            }
        });
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(FaSongActivity.this, "发送指令：" + editText_send.getText().toString(), Toast.LENGTH_SHORT).show();
            }
        });
